...
<form name="main" method="post" action="process.php">
	...
	<p>
		P名<br /> &ensp;<input type="text" name="name" size="20" maxlength="10"><br />
		Twitter<br /> &ensp;＠ <input type="text" name="twitter" size="15"
			maxlength="15"
			value="<?php
	...
	<p>
		<b>生成する難易度を選択してください</b><br /> &ensp; <select name="limit_1">
			...
			上から４つ目以降の難易度は小さめに表示されます<br /> たくさん選ぶとはみ出るかもしれません(ごめんなさい、その場合は教えて下さい。)<br />
			選択していない難易度でも総合評価には含まれます。(別々にしろという要望が多ければ対応するかもしれません)
		</span>
	</p>

	<p>
		集計方法：<select name="limited_1" disabled>
			<option value="All">全楽曲で生成する</option>
			<option value="Limited">限定楽曲を除く</option>
			<option value="CD">先行解禁曲を除く</option>
		</select><br /> <span style="font-size: 80%;"> <span
			style="color: red"> <b>まだ選択できません。近日実装予定です</b>
		</span><br /> "限定楽曲を除く"はススメオトメなどを含む限定タブにある曲全てを集計しません。<br />
	...
	<table cellspacing="1" cellpadding="5" rules="cols">
		...
		<tr class="bg34">
			...
			<td><input id="34_4" class="Master" type="checkbox" name="arr[]"
				...
				<tr class="bg35">
			<th class="index"><div class="wrapper">Naked Romance</div></th>
			<td><input id="35_1" class="Debut" type="checkbox" name="arr[]"
				value="07_5"></td>
			<td><input id="35_2" class="Regular" type="checkbox" name="arr[]"
				value="13_16"></td>
			<td><input id="35_3" class="Pro" type="checkbox" name="arr[]"
				value="17_12"></td>
			<td><input id="35_4" class="Master" type="checkbox" name="arr[]"
				value="26_9"></td>
		</tr>
		<tr class="bg17">
		...
		<tr class="bg27">
			...
			<td><input id="27_4" class="Master" type="checkbox" name="arr[]"
				...
				<tr class="bg31">
			<th class="index"><div class="wrapper">M@GIC☆</div></th>
		...
		<tr class="bg92">
			...
			<td><input id="92_4" class="Master" type="checkbox" name="arr[]"
				value="26_7"></td>
						...
						<tr class="bg93">
			<th class="limited"><div class="wrapper">Orange Sapphire</div></th>
			<td><input id="93_1" class="Debut" type="checkbox" name="arr[]"
				value="8_18"></td>
			<td><input id="93_2" class="Regular" type="checkbox" name="arr[]"
				value="13_17"></td>
			<td><input id="93_3" class="Pro" type="checkbox" name="arr[]"
				value="17_13"></td>
			<td><input id="93_4" class="Master" type="checkbox" name="arr[]"
				value="26_10"></td>
		</tr>
		<tr class="bg33">
	...
	<p>
		<b>生成後の処理を選択してください</b><br /> <label for="download"><input type="radio"
			name="process" id="download" value="download" checked>画像をダウンロードする</label><br>
	<?php
	// セッションに入れておいたさっきの配列
...
<p style="font-size: 13px;">
	Ratingの計算式は " ( フルコン曲のレベル合計÷アーニャソロまでのレベル合計 ) ×15 "です。<br />不具合報告やご意見などは<a
